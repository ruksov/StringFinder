...
TEST_F(TestThresholdMatcher, DefaultCtor)
{
    ASSERT_NO_THROW(CreateMatcher());
}

TEST_F(TestThresholdMatcher, MiddleChunckMatch)
{
...
TEST_F(TestThresholdMatcher, EndChunckMatch)
{
...
TEST_F(TestThresholdMatcher, EndChunckMatch_LessThanThreashold)
{
